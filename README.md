...
```javascript
import gcopy from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-gcopy@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-base-gcopy/tags). For example,

```javascript
import gcopy from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-gcopy@v0.0.8-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-gcopy@deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/blas-base-gcopy/actions/workflows/test.yml/badge.svg?branch=v0.0.8
[test-url]: https://github.com/stdlib-js/blas-base-gcopy/actions/workflows/test.yml?query=branch:v0.0.8
