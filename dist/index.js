"use strict";var b=function(c,a){return function(){try{return a||c((a={exports:{}}).exports,a),a.exports}catch(f){throw (a=0, f)}};};var g=b(function(H,m){
function z(c,a,f,u,o,i,t){var v,e,s,r,l,n,q;for(v=a.data,e=o.data,r=a.accessors[0],s=o.accessors[1],l=u,n=t,q=0;q<c;q++)s(e,n,r(v,l)),l+=f,n+=i;return o}m.exports=z
